package id.sch.smktelkom_mlg.www.pesankopi;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String createOrderSummary(int price, String name, boolean addWhippedCream, boolean addChocolate) {//hasil pemesanan
